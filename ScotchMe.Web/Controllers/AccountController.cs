...
using ScotchMe.Sessions;
using ScotchMe.Web.Controllers.Results;
using ScotchMe.Web.Models;
using ScotchMe.Web.Models.Account;
...
{
    public class AccountController : ScotchMeControllerBase
    {
